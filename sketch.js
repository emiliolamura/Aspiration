...
function draw(){
    ...
    if (form===1) {formato1(); createCanvas(canvaw, canvah);}
    if (form===2) {formato2(); createCanvas(canvaw, canvah);}
    if (form===3) {formato3(); createCanvas(canvaw, canvah);}
    if (form===4) {formato4(); createCanvas(canvaw, canvah);}
    if (form===5) {formato5(); createCanvas(canvaw, canvah);}
